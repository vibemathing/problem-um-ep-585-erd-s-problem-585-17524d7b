...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-585-erd-s-problem-585-17524d7b-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-585"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-585-erd-s-problem-585-17524d7b-v1",
      "problem_contract_sha256": "0c4739604befce1bdf2fbcdc4f5e5098d7904e08823d647e849617a40ade7021",
      "problem_id": "problem:um-ep-585-erd-s-problem-585-17524d7b",
      "route_id": "route:um-ep-585-erd-s-problem-585-17524d7b-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-585-erd-s-problem-585-17524d7b-source-fidelity-01",
      "graph_id": "graph:um-ep-585-erd-s-problem-585-17524d7b-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-585-erd-s-problem-585-17524d7b-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-585-erd-s-problem-585-17524d7b-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "What is the maximum number of edges that a graph on $n$ vertices can have if it does not contain two edge-disjoint cycles with the same vertex set?"
          },
          "statement_sha256": "133701f0f536011f088754df4d76cff96e3c7bfa7e57f9b039cc7f7b221c8fd7"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-585-erd-s-problem-585-17524d7b-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-585-erd-s-problem-585-17524d7b-root",
      "route_id": "route:um-ep-585-erd-s-problem-585-17524d7b-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-585-bdcb6e7348d3",
        "url": "https://www.unsolvedmath.com/problems/EP-585"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
